                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    @if (array_key_exists($key * 6, $photos))
                                        <div class="col py-2">
                                            <a href="/home/productdetail/{{ $products[$key]->id }}">
                                ...
                                <div class="row">
                                    @for ($i = 1; $i <= 2; $i++)
                                        @if (array_key_exists($key * 6 + $i, $photos))
                                            <div class="col py-3">
                                                <a href="/home/productdetail/{{ $products[$key * 6 + $i]->id }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    @if (array_key_exists($key * 6 + 5, $photos))
                                        <div class="col py-3">
                                            <a href="/home/productdetail/{{ $products[$key * 6 + 5]->id }}">
                        ...
                        @foreach ($products as $key => $product)
                            <div class="col-md-6">
                                <div class="row">
                                    @if (array_key_exists($key * 6, $photos))
                                        <div class="col py-2">
                                            <a href="/productdetail/{{ $products[$key]->id }}">
                                                <img class="img-fluid rounded" src="{{ asset($photos[$key * 6]) }}"
                                                    alt="bssblocks image placeholder" height="100%" width="100%" />
                                            </a>
                                        </div>
                                ...
                                <div class="row">
                                    @for ($i = 1; $i <= 2; $i++)
                                        @if (array_key_exists($key * 6 + $i, $photos))
                                            <div class="col py-3">
                                                <a href="/productdetail/{{ $products[$key * 6 + $i]->id }}">
                                                    <img class="img-fluid rounded"
                                                        src="{{ asset($photos[$key * 6 + $i]) }}"
                                                        alt="bssblocks image placeholder" height="100%"
                                                        width="100%" />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    @if (array_key_exists($key * 6 + 5, $photos))
                                        <div class="col py-3">
                                            <a href="/productdetail/{{ $products[$key * 6 + 5]->id }}">
                                                <img class="img-fluid rounded" src="{{ asset($photos[$key * 6 + 5]) }}"
                                                    alt="bssblocks image placeholder" height="100%" width="100%" />
                                            </a>
                                        </div>
